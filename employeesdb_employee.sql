...
CREATE TABLE `employee` (
  ...
  `DependentGender` varchar(45) DEFAULT NULL,
  `DependentDOB` date DEFAULT NULL,
  `DependentRelationship` varchar(45) DEFAULT NULL,
  `EducationType` varchar(45) DEFAULT NULL,
  `EducationStartDate` date DEFAULT NULL,
  `EducationEndDate` date DEFAULT NULL,
  `EducationQualificationType` varchar(45) DEFAULT NULL,
  `Institution` varchar(45) DEFAULT NULL,
  `InstitutionAddress` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2021-05-24 16:46:22
